...
function Data() {
    ...
    const toRotate = [ "Programmer", "Web Developer", "Discord Bot Developer", "Back End Developer" ];
    const period = 2000;
    ...
    const tick = () => {
      ...
      function line() {
        if(text <= 0) {
            ...
            return 'home__subtitle-line'
        }
      }

    return(
        <div className="home__data">
            <h1 className="home__title">Ahmad Irfan Ma'ruf Maulana
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className={line()}>{text}</h3>
            <p className="home__description">Selamat datang di situs website saya, di mana Kamu dapat menemukan portofolio saya</p>
